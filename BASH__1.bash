<<<<<<< HEAD
# BASH001 # installs 
    apt-get install ghc && apt-get install make && aptitude install -y libgmp3c2 && apt-get install libncurses5-dev && apt-get install Htop && apt-get install mc && apt-get install git  
=======
# BASH001.bash 
...
>>>>>>> fe705a7672445493e319619ed37b45e75a3d3d16
